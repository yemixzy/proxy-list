...
|File|Content|Count|
|----|-------|-----|
|[data.txt](https://raw.githubusercontent.com/yemixzy/http-proxy/main/proxy-list/data.txt)|`ip_address:port` combined (seperated new line)|162|
|[data.json](https://raw.githubusercontent.com/yemixzy/http-proxy/main/proxy-list/data.json)|`ip, port`|162|
|[data-with-geolocation.json](https://raw.githubusercontent.com/yemixzy/http-proxy/main/proxy-list/data-with-geolocation.json)|`ip, port, geolocation`|162|
