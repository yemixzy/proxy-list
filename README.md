...
|File|Content|Count|
|----|-------|-----|
|[data.txt](https://raw.githubusercontent.com/yemixzy/http-proxy/main/proxy-list/data.txt)|`ip_address:port` combined (seperated new line)|154|
|[data.json](https://raw.githubusercontent.com/yemixzy/http-proxy/main/proxy-list/data.json)|`ip, port`|154|
|[data-with-geolocation.json](https://raw.githubusercontent.com/yemixzy/http-proxy/main/proxy-list/data-with-geolocation.json)|`ip, port, geolocation`|154|
